...
public interface UserDao extends AutoCloseable {
    ...
    @SqlQuery("select u.* from user u, orderTable o where u.userId = o.userId and o.orderId = :orderId")
    ...
    @GetGeneratedKeys
    @SqlUpdate("Insert into userCategory (userId,categoryId) values (:userId, :categoryId)")
    int newUserCategory(
    ...
    @SqlUpdate("update user set userName=:userName, userPassword=:userPassword, email=:userEmail, weight=:weight, displayName=:displayName where userId=:userId")
    void updateUser(
            @Bind("userId") int userId,
