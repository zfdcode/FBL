...
public class Meal {
    ...
    private String[] meal_ingredints;

    private String[] meal_categories;

    public Meal(int meal_id, String meal_name, byte[] meal_image, float meal_rating, int meal_helath_value, Date meal_preparation_time, float meal_energy, float meal_protein, float meal_total_fat, float meal_saturated, float meal_total_carbohydrate, float meal_sugar, float meal_sodium, String[] meal_ingredints, String[] meal_categories) {
        ...
        this.meal_ingredints = meal_ingredints;
    ...
    public String[] getMeal_ingredints() {
        return meal_ingredints;
    }

    public void setMeal_ingredints(String[] meal_ingredints) {
        this.meal_ingredints = meal_ingredints;
    }

    public String[] getMeal_categories() {
        return meal_categories;
    }

    public void setMeal_categories(String[] meal_categories) {
        this.meal_categories = meal_categories;
    }
}
